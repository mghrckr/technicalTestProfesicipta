...
export default function SalesOrderList({ navigation }) {
    return (
        <View style={styles.container}>
            ...
            <View style={{ flex: 1, backgroundColor: '#677800' }}>
                <View style={{
                    flex: 0.25, backgroundColor: '#EEEEEE', borderTopLeftRadius: 30,
                ...
                <View style={{ flex: 0.17, backgroundColor: '#EEEEEE' }}>
                    <View style={{ flex: 1, flexDirection: 'row' }}>
                    ...
                    <View style={{ flex: 1 }}>
                        <Pressable style={styles.addBtn}
                            onPress={() => {
                                navigation.navigate('SalesOrderInput')
                                console.log('add');
                            }}>
                ...
                <View style={{ flex: 0.7, justifyContent: 'center', alignContent: 'center', alignItems: 'center', backgroundColor: '#EEEEEE' }}>
                    <Card />
                    <Card />
                    <Card />
                    <Card />
